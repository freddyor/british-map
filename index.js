...
<body>
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-content">
            ...
            <div class="project-info">
                This project costs me to run, as a 22 year old I can't fund it forever. The project relies on public voluntary support ❤️
            </div>
    ...
    <script>
        ...
        window.onclick = function(event) {
            if (!event.target.matches('#custom-bmc-button')) {
        ...
        const supportButton = document.getElementById('custom-bmc-button');
        const dropdownContent = supportButton.nextElementSibling;
        dropdownContent.style.width = `${supportButton.offsetWidth}px`;
