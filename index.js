...
// Modal container for People Marker
...
peoplePopupContainer.innerHTML = `
  <div class="image-name-container">
    ...
    <div>
      <div><input type="text" id="people-popup-name" placeholder="Name" value="Person name here..." style="font-size: 16px; font-weight: bold;"></div>
  ...
  <div class="rounded-box event-card" id="people-event1-card">
    ...
    <textarea id="people-popup-event1" placeholder="Event 1" style="width: 100%; box-sizing: border-box; font-size: 12px;">Optional interesting fact here. If there's nothing interesting, REMOVE these cards!</textarea>
  </div>
  <div class="rounded-box event-card" id="people-event2-card">
    ...
    <textarea id="people-popup-event2" placeholder="Event 2" style="width: 100%; box-sizing: border-box; font-size: 12px;">Another optional fact here. Click on the preview word to edit them (the writing in purple just above this)</textarea>
  </div>
  <div class="rounded-box event-card" id="people-event3-card">
    ...
    <textarea id="people-popup-event3" placeholder="Event 3" style="width: 100%; box-sizing: border-box; font-size: 12px;">Another optional fact here. Remember to use an emoji after each sentence 😎</textarea>
  </div>
  <div class="coordinates-container">
    <div class="input-row">
...
// Event listeners for the People Marker button and modal
...
// Event listener for the "Add Marker" button in the People Marker modal
document.getElementById('add-people-popup-marker').addEventListener('click', () => {
  ...
  // Save marker data to Firestore
  addDoc(collection(db, 'peopleMarkers'), {
    name,
    dates,
    tldr,
    longitude,
...
// Event listener for the "Cancel" button in the People Marker modal
...
function resetPeopleForm() {
  document.getElementById('people-popup-name').value = "Person name here...";
  ...
  document.getElementById('people-popup-event1').value = "Optional interesting fact here. If there's nothing interesting, REMOVE these cards!";
