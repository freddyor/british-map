        ...
        <div style="padding: 0; margin: 0;">
            ...
            ${videoUrl ? `
                <div style="margin-top: 10px; width: 100%; margin-bottom: 10px;"> <!-- Add margin-bottom here -->
                            <iframe width="180" height="310" src="${videoUrl}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="display: block; width: 180; height: 310px; border: none; margin: 0; padding: 0;"></iframe>
                </div>
            ` : ''}
        </div>
    `;
